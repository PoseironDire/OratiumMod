...
{
	public class GleaverMinionProjectile : ModProjectile

	{
		...
		public override void AI() {
			...
			if (player.dead || !player.active) {
				player.ClearBuff(ModContent.BuffType<GleaverBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<GleaverBuff>())) {
